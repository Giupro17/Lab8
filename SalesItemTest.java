...
public class SalesItemTest
{
    ...
    public void testAddCommentSameAuthor()
    {
        ...
        assertEquals(true, salesIte1.addComment("James Duckling", "This book is great. I performbrain surgery every week now.", 4));
        assertEquals(false, salesIte1.addComment("James Duckling", "beebop", 2));
